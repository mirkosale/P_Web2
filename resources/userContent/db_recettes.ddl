...
-- * Generation date: Tue Mar 29 15:25:05 2022 
-- * LUN file: F:\01-Projets\040-P_Web2\db_recettes.lun 
-- * Schema: db_recettes/SQL1 
-- ********************************************* 
...
create table t_recette (
     ...
     recCategory varchar(20) not null,
...
alter table t_note add constraint REF_t_not_t_rec_FK
     ...
     references t_recette(idRecette);
...
INSERT INTO t_recette (recName, recCategory, recListOfItems, recPreparation, recImage) VALUES ("Tartare de crevette","entrée","1 jaune d'oeuf frais, 1c.c de moutard, 0.5c.c de jus de citron, 1gousse d'ail pressée, 1dl d'huile de colza non pressée à froid, 0.25c.c de sel, un peu de poivre, 240g de crevette pour cocktail hachée finement, 1.cs de Ketchup,de persil plat coupé finement, d'aneth coupés finement, 6tranches de pain de mie grillées, coupé en quatre, 25g de beurre salé","Bien mélanger au fouet dans un bol jaune d’oeuf, moutarde, jus de citron et ail. Verser l’huile au début goutte à goutte, sans cesser de remuer, puis en filet, saler, poivrer.
...
INSERT INTO t_recette(recName, recCategory, recListOfItems, recPreparation, recImage) VALUES ("Burrata sur pain grillé","entrée","1 baguette ou 200g de pain bis, 3c.s d'huile d'olive, 50g de roquette, 2 burratas(d'environ 150g), 1c.s de mélange d'épices flocons de tomates","Couper le pain en très grandes tranches biseautées. Faire griller les tranches dans la poêle-gril bien chaude ou dans une poêle, dresser sur un plat. Arroser d’un filet d’huile. Effeuiller la roquette, répartir dessus. Prélever la burrata avec une cuillère à soupe, répartir dessus, parsemer du mélange d’épices.","img.jpg");
INSERT INTO t_recette(recName, recCategory, recListOfItems, recPreparation, recImage) VALUES ("Moules gratinées","entrée","1c.s d'huile d'olive, 1échalote hachée grossièrement, 500g de moules(brosser soigneusement les moules sous l’eau courante froide, les ébarber, jeter les coquilles ouvertes), 1dl de vin blanc, 80g de crème fraiche, 1 jaune d'oeuf frais, 2c.s de parmesan rapé, 0.25c.c de sel, un peu de poivre, 20g de beurre, une tranche de pain de mie en petit dés, 2c.s d'aneth ciselée, 0.25 c.c de esel ","","img.jpg");
INSERT INTO t_recette(recName, recCategory, recListOfItems, recPreparation, recImage) VALUES ("Flûtes à la tomate","entrée","150g de tomates séchées à l'huile,0.25 bouquet de romarin, 0.25 bouquet de sauge, 80g de sbrinz râpé, 0.25c.c de sel, un peu de poivre, 1 abaisse de pâte à pizza, 1 oeuf ","Préchauffer le four à 200°C.
